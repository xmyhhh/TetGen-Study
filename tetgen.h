...
//============================================================================//
	...
	enum verttype {
		UNUSEDVERTEX,      // 未使用的顶点
		DUPLICATEDVERTEX,  // 重复的顶点
		RIDGEVERTEX,       // 山脊（脊线）顶点
		// ACUTEVERTEX,    // 锐角顶点（已注释掉）
		FACETVERTEX,       // 面顶点
		VOLVERTEX,         // 体顶点
		FREESEGVERTEX,     // 自由边上的顶点
		FREEFACETVERTEX,   // 自由面上的顶点
		FREEVOLVERTEX,     // 自由体上的顶点
		NREGULARVERTEX,    // 非规则顶点
		DEADVERTEX         // 已删除的顶点
	};
...
inline void tetgenmesh::setpointtype(point pt, enum verttype value) {
	((int*)(pt))[pointmarkindex + 1] = ((int)value << 8) + (((int*)(pt))[pointmarkindex + 1] & (int)255);
}
